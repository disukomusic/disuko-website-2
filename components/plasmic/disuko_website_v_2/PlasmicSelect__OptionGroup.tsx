...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: RKGJ5yqmTC3/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: Zi5V_b_8iY8/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__cvedL)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__f2QMl)}
              />
            </React.Fragment>
          ),
          value: args.children
