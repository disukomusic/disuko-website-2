...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: 65tuioDom8B/component
import Select__Option from "../../Select__Option"; // plasmic-import: FLM-PtM21gf/component
import Select__OptionGroup from "../../Select__OptionGroup"; // plasmic-import: RKGJ5yqmTC3/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic_disuko_website_v_2.module.css"; // plasmic-import: bsHvoheJaXyaeWhnCxRakT/projectcss
import sty from "./PlasmicSelect.module.css"; // plasmic-import: Zi5V_b_8iY8/css

import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: ubvIrNI5vPk/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: M61i9m0MmpU/icon
    ...
    if (!("children" in props)) {
      props = {
        ...
        children: (
          <React.Fragment>
            <Select__Option
              className={classNames("__wab_instance", sty.option___168G1)}
              value={"value1" as const}
            >
              {"Option 1"}
            </Select__Option>
            ...
            <Select__Option
              className={classNames("__wab_instance", sty.option__ybvm2)}
              value={"value2" as const}
            >
              {"Option 2"}
            </Select__Option>
