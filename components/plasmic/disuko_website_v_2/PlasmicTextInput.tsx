...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: W4W4JfxNDKp/css

import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: FAFkejJ7vqN/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: I702jh1jR4G/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__k4Nww)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___0BrVc)}
                role={"img"}
              />
            ),
